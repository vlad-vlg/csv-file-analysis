...
label_01 = tk.Label(text = '', relief='sunken', bg='azure', width=50, bd=2)
...
label_11 = tk.Label(text = '', relief='sunken', bg='azure', width=50, bd=2)
...
label_21 = tk.Label(text = '', relief='sunken', bg='azure', width=50, bd=2)
label_21.grid(row=2, column=1, padx=10, pady=10, sticky='ew')

# Создание текстового вывода с прокруткой
output_text = st(height=22, width=50, bd=5)
